...
public class ConfigConstants {
    ...
    /**
     * Master opt-in switch for the Spring configuration record/replay feature.
     * Off by default; when off, the spring-config module installs no instrumentation at all
     * (see SpringConfigModuleInstrumentation#instrumentationTypes).
     */
    public static final String ENABLE_SPRING_CONFIG = "arex.spring.config";
}
